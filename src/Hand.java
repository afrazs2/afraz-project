public class Hand
{
    ...
    private  static final int handCount = PokerProject.gethandcount();
    private static int five;
    private  static int four;
    private static  int full;
    private static  int three;
    private static int tpair;
    private  static int opair;
    private  static int high;
    private   static int totalBid;
    private  static int totalBidWild;
    private  static int jackCount;
    private  static final int[] prevRankWild = new int[handCount]; // new rankings aswell because of the fact that rankings will change if jack = 1 and theres a new highest ranking hierarchy.
    private  static final int[] prevHandTypeWild = new int[handCount]; // since in this one if there is a jack it acts as the card that makes the card the highest hand, we need to create a new handtype intake.
    private static final int[] prevHandType = new int[handCount]; // Basically, the way im ranking them is every hand we read is by keeping track of the previous type and using that to rank it in an array. We determine the handCount with the previous scan attempt. In particular, this is used to rank the handtype from 5oak, 4oak, fh, 3oak, 2 pair, one pair, highcard from 7 to 1 respectively
    private static final int[] prevRank = new int[handCount]; // this is used to rank the hands by giving it a position and then how many hands are stronger than this hand.
    private static final int[] prevCard1 = new int[handCount]; // first card in the hand
    private static final int[] prevCard2 = new int[handCount]; // second card of the hand
    private static final int[] prevCard3 = new int[handCount]; // third card of the hand
    private static final int[] prevCard4 = new int[handCount]; // 4th card of the hand
    private static final int[] prevCard5 = new int[handCount]; // 5th card of the hand.
    private static final int[] prevCard1Wild = new int[handCount]; // these are the same purpose as the above but for the wild version
    private static final int[] prevCard2Wild = new int[handCount];
    private static final int[] prevCard3Wild = new int[handCount];
    private static final int[] prevCard4Wild = new int[handCount];
    private static final int[] prevCard5Wild = new int[handCount];
    private static final int[] bidValues = new int[handCount];
    ...
    public int handRankingWild;




    public int[] cardValues;
    public int[] cardValuesWild;


    public Hand(String[] cards, int bid) {
        this.indiCards = cards;
        this.bid = bid;
    ...
    private void convertCardsandRank() {
        ...
        int[] cardNumericValueWild = new int[5];
    ...
    public void evaluateHand()
    {
        ...
        handRanking = 0; // the hands need a hierarchy for the actual ranking so we use this variable to assign it depending on the hand type.
    ...
    public static void getHandTotals() {
